...
export const PLANS = [
  ...
  },
  {
    ...
    consultations: 100,
    period: 'mes',
    features: ['Historia clínica completa', 'Nota de evolución hospitalaria', 'CIE-10 automático', 'Anti-glosas colombianas'],
    cta: 'Empezar gratis',
    highlight: false,
  },
  {
  ...
  },
  {
    ...
    consultations: 500,
    period: 'mes',
    features: ['Todo el plan Avanzado', 'Acceso anticipado a nuevas funciones', 'Soporte directo por WhatsApp', 'Sin límite de especialidades'],
    cta: 'Empezar gratis',
    highlight: false,
