...
const ONBOARDING_PLANS = [
  {
    ...
    price: 39900,
    hcs: 100,
    features: ['Historia clínica completa', 'Nota de evolución hospitalaria', 'CIE-10 automático', 'Anti-glosas / documentación sólida'],
    highlight: false,
    badge: null,
  },
  {
  ...
  },
  {
    ...
    price: 109900,
    hcs: 500,
    features: ['Todo lo del Avanzado', 'Acceso anticipado a nuevas funciones', 'Soporte directo por WhatsApp', 'Sin límite de especialidades'],
    highlight: false,
    badge: 'Alto volumen',
  },
]
